package com.example.hangquocte.danhsachloai;
...
import com.example.hangquocte.R;
...
public class AdapterLoai extends RecyclerView.Adapter<AdapterLoai.ViewHolder>{
    ...
    @NonNull
    @Override
    public AdapterLoai.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View itemView = layoutInflater.inflate(row_layout,parent,false);
        return new AdapterLoai.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterLoai.ViewHolder holder, int position) {
